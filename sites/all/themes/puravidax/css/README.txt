...
To use these stylesheets, rename the files and puravidax with the name of your theme.
...
puravidax-alpha-default-narrow.css  
...
puravidax-alpha-default-normal.css
...
puravidax-alpha-default-wide.css
